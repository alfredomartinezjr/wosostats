---
title: "Match Stats: NWSL 2015 - Portland Thorns FC vs. Seattle Reign FC"
...
d <- getURL("https://raw.githubusercontent.com/amj2012/wosostats/master/source/csv/nwsl-2015/2015-nwsl-ptfc-srfc-072215.csv")
...
This is a summary of match stats from the NWSL 2015 regular season match between Portland Thorns FC and Seattle Reign FC. It is broken down into what are defined as "attacking," "passing," "possession," "defending," and "goalkeeping" stats.
...
#Sources
* The full match can be seen at [https://www.youtube.com/watch?v=DZsUqt6wTm8](https://www.youtube.com/watch?v=DZsUqt6wTm8).
* The csv file with all the match events from which this analysis is source [can be found here on GitHub.](https://raw.githubusercontent.com/amj2012/wosostats/master/source/csv/nwsl-2015/2015-nwsl-ptfc-srfc-072215.csv)
* The raw Excel file, in all it's ugliness, with the blank spots that I filled in with some help from R, [can be found here on GitHub.](https://github.com/amj2012/wosostats/blob/master/source/excel/nwsl-2015/2015-nwsl-ptfc-srfc-072215.xlsx)
* If you have R Studio, can view this entire page and all the source code behind each table by [downloading the R Markdown file here on GitHub.](https://github.com/amj2012/wosostats/blob/master/analysis/rmd/nwsl-2015/2015-nwsl-semifinal-srfc-was-091315.Rmd)
