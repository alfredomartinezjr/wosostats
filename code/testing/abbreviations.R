...
AbbreviationConverter_PossAction =
  R6Class("Abbreviation_PossAction",
  inherit = AbbreviationConverter_Base,

  public =
    list
    (
      column_name = "poss.action",
...
AbbreviationConverter_PlayType =
  R6Class("Abbreviation_PlayType",
  inherit = AbbreviationConverter_Base,

  public =
    list
    (
      column_name = "play.type",
...
AbbreviationConverter_DefAction =
  R6Class("Abbreviation_DefAction",
  inherit = AbbreviationConverter_Base,

  public =
    list
    (
      column_name = "def.action",

      initialize = function()
      {
        self$add_abbreviation("^dbs",   "ball.shield")
        self$add_abbreviation("^bs",    "ball.shield")
        self$add_abbreviation("^dis",   "dispossessed")
        self$add_abbreviation("^ds",    "dispossessed")
        self$add_abbreviation("^dlt",   "dispossessed")
        self$add_abbreviation("^tb",    "tackles.ball")
        self$add_abbreviation("^tba",   "tackles.ball.away")
        self$add_abbreviation("^tbw",   "tackles.ball.won")
        self$add_abbreviation("^dtm",   "dribbled.tackles.missed")
        self$add_abbreviation("^dor",   "dribbled.out.run")
        self$add_abbreviation("^dt",    "dribbled.turned")
...
AbbreviationConverter_PossPlayerDisciplinary =
  R6Class("PossPlayerDisciplinary",
  inherit = AbbreviationConverter_Base,

  public =
    list
    (
      column_name = "poss.player.disciplinary",
...
AbbreviationConverter_DefPlayerDisciplinary =
  R6Class("DefPlayerDisciplinary",
  inherit = AbbreviationConverter_Base,

  public =
    list
    (
      column_name = "def.player.disciplinary",
