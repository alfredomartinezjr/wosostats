...
That’s the short of it. The basics is that I tracked every match “action” out of a list (e.g. forward passes, take ons won, aerial duels won, etc.) onto an Excel spreadsheet, filled in the blanks and converted the file into a csv file, and analyzed what I wanted with R.

I’d ideally want to create a place where you can play with the stats yourself and analyze a variety of matches and players, but right now I only have this match. I’m going to start tracking more matches, ideally for more than the NWSL, but definitely starting with the NWSL season, but I’ll never get it done if I’m the only one tracking this. (I don’t know of another site on the web that has advanced soccer stats like these for women’s soccer. Help!)

Want to log stats on your own and help out? Read more [here.](https://github.com/amj2012/wosostats/blob/master/resources/how-to-log-stats.md) To learn about action definitions that are used to log stats and used in this analysis, read more [here.](https://github.com/amj2012/wosostats/blob/master/resources/definitions.md)
...
* The csv file with all the match events from which this analysis is source [can be found here on GitHub.](https://raw.githubusercontent.com/amj2012/wosostats/master/source/csv/nwsl-2015/2015-nwsl-championship-100115.csv)
* The raw Excel file, in all it's ugliness, with the blank spots that I filled in with some help from R (more on that below), [cab also be found here on GitHub.](https://github.com/amj2012/wosostats/blob/master/source/excel/nwsl-2015/2015-nwsl-championship-100115.xlsx)
* If you have R Studio, can view this entire page and all the source code behind each table by [downloading the R Markdown file here on GitHub.](https://raw.githubusercontent.com/amj2012/wosostats/master/analysis/rmd/nwsl-2015/2015-nwsl-championship-100115.Rmd)
* The R files I used to tidy the original raw Excel file and to help create the tables [can be found here on GitHub.](https://github.com/amj2012/wosostats/tree/master/code/version-1)