---
title: "Match Stats: NWSL 2015 Semifinal - Seattle Reign FC vs. Washington Spirit"
...
This is a summary of match stats from the NWSL 2015 Semifinal between Seattle Reign FC and the Washington Spirit. It is broken down into what are defined as "attacking," "passing," "possession," "defending," and "goalkeeping" stats.
...
## Merge columns
t4 <- cbind(t2,t3)
t4 <- t4[order(-t4[,"Completed"], -t4[,"Comp.Pct"], -t4[,"Pct.of.Passes"]),]
...
#Sources
* The full match can be seen at [https://www.youtube.com/watch?v=_jdBcOVuEus](https://www.youtube.com/watch?v=_jdBcOVuEus).
* The csv file with all the match events from which this analysis is source [can be found here on GitHub.](https://raw.githubusercontent.com/amj2012/wosostats/master/source/csv/nwsl-2015/2015-nwsl-semifinal-srfc-was-091315.csv)
* The raw Excel file, in all it's ugliness, with the blank spots that I filled in with some help from R, [can be found here on GitHub.](https://github.com/amj2012/wosostats/blob/master/source/excel/nwsl-2015/2015-nwsl-semifinal-srfc-was-091315.xlsx)
